  ...
  return (
    <div className='mt-10 bg-primary-3 px-5 pt-3 rounded-md shadow-md'>
      ...
      <div className='flex flex-col mt-6'>
        <Rotate top left>
          <Link href='https://asuman315.github.io/get-bmi' passHref>
        ...
        <Zoom left>
          <Link href='https://youtu.be/xX2YajoT4z8' passHref>
            <button className='uppercase border-none outline-none py-3 mt-3 tracking-widest font-bold text-lg rounded bg-primary-2 w-full'>
              short demo video
            </button>
          </Link>
        ...
        <Rotate bottom left>
          <Link href='https://github.com/asuman315/get-bmi/tree/master' passHref>
